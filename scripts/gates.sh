...
FAIL=0
MIN_WORDS=400
ANTIWORDS="breathtaking|stunning|unforgettable|magical|paradise|hidden gem|incredible|amazing|spectacular|unique|world\.class|seamless|curated|immersive|life\.changing|unparalleled|elevate your|bucket\.list|nestled|boasts|renowned|once\.in\.a\.lifetime|pristine|best"
